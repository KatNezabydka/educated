...
def show_help():
    ...
    print(Fore.YELLOW + "--> show-phone [name]: Show the phone number for the specified contact.")
    ...
    print(Fore.YELLOW + "--> find-notes-by-tag [tag]: Show notes in the note book by tag.")
